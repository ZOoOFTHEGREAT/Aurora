    ...
    public partial class intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Fname = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: false),
                    Lname = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telephone = table.Column<string>(type: "varchar(MAX)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineOne = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: false),
                    LineTwo = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: true),
                    Country = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: false),
                    City = table.Column<string>(type: "varchar(MAX)", maxLength: 25, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaymentType = table.Column<string>(type: "varchar(MAX)", maxLength: 20, nullable: false),
                    Provider = table.Column<string>(type: "varchar(MAX)", maxLength: 20, nullable: false),
